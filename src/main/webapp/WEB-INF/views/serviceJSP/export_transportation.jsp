...
<body data-mode="${mode2}" data-context-path="${pageContext.request.contextPath}">
    ...
    <div class="page-container">
        ...
        <div class="content-container-form">
            <h2>エクスポート <small>交通費</small></h2>

            <form class="info_table" action="<%=request.getContextPath()%>/Export_reimbursement" method="post">
...
<!--                                        <option value="差戻し">差戻し</option>-->
                        ...
                        <tbody>
                            <c:forEach var="p" items="${paymentList3}">
...
<!--                </div>-->
    ...
    document.querySelectorAll('.clickable-row').forEach(row => {
      row.addEventListener('click', function (e) {
        ...
        url += '&context=exporttransportation';
